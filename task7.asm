...
.stack 100h
.data 
string1 db "Enter marks of Subject: $"
string2 db "Obtained Marks of student: $"		;strings for user ease
string3 db "Percentage of student: $"
string4 db "Enter Total Marks: $"
number dw 0
total dw 0
temp dw 0
...
lea dx,string4			;loading effective address of string4
mov ah,09
int 21h
input2:
mov ah,01				;taking input
...
lea dx,string3			;loading effective address of string 3
mov ah,09
int 21h

mov ax,sum
mov bx,100
mul bx						;multiplying obtained marks by 100 to divide with total marks
mov dx, 0
mov bx,total
div bx
l3:
mov percent,ax				;moving value in a percent variable to calculate %
mov bx,10
mov dx,0
div bx
inc count1
...
dec count1
l4:
pop dx					;poping values digit by digit and adding 48
add dx,48
mov ah,02
int 21h
dec count1				;decrementing counter to keep track
